...
async function main() {
    try {
        ...
        const respuesta = await contract.evaluateTransaction('queryVoter','1000W');
        const esperado = '';
        ...
        const obj = JSON.parse(respuesta.toString())

        if (Object.keys(obj).length = 2 && obj.result == true && obj.data.ballot=="Ballot_0") {
